...
lock: lock.cpp face_detect.cpp
	g++ -g lock.cpp face_detect.cpp -o lock.out -lopencv_core -lopencv_face -lopencv_videoio -lopencv_objdetect -lopencv_imgproc -lopencv_imgcodecs
